...
df = spark.read.format("csv").option("header","true").\
    load("Files/0_LANDING/INEP/microdados_censo_da_educacao_superior/*/Microdados do Censo da Educaç╞o Superior */dados/MICRODADOS_CADASTRO_IES_*.CSV",
...
df.write.format("delta").mode("Overwrite").save("Files/1_BRONZE/INEP/TBL_INEP_MICRODADOS_CADASTRO_IES")
