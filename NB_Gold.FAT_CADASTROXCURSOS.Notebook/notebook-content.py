...
CaminhoDestino = "Files/3_GOLD/FAT_CADASTROXCURSOS"
NomeTabelaDestino = "FAT_CADASTROXCURSOS"
...
]).filter("NU_ANO_CENSO is not null").dropDuplicates().orderBy("NU_ANO_CENSO")
